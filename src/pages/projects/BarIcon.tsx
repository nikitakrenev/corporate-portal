    ...
    return (
        ...
        >
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M14.6666 14.6667H18.6666V18.6667H14.6666V14.6667ZM15.3333 15.3333H18V18H15.3333V15.3333Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M14.6666 21.3333H18.6666V25.3333H14.6666V21.3333ZM15.3333 22H18V24.6667H15.3333V22Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M25.3333 21.3333H21.3333V25.3333H25.3333V21.3333ZM24.6666 22H22V24.6667H24.6666V22Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M21.3333 14.6667H25.3333V18.6667H21.3333V14.6667ZM22 15.3333H24.6666V18H22V15.3333Z"
                fill={color}
            />
            <path
